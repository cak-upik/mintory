...
public class LaporanKartuBayarPth extends javax.swing.JInternalFrame {
    ...
    private List<closingBulananPutih> listClosingSaldoAwalPutih;
    private List<closingBulananPutih> listClosingBulan;
    private boolean isFirstClosing = false;
    private int currentMonth, firstSaldoAwalMonth;
    ...
    public LaporanKartuBayarPth() {
        initComponents();
        listClosingBulan = Main.getTransaksiService().closingBulananPutihFirstRecord();
    ...
    private void btnMuatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMuatActionPerformed
        ...
        try {
            ...
            listClosingSaldoAwalPutih = Main.getTransaksiService().closingBulananPutihRecordForSaldoAwalAll(Main.getSistemService().findKomposisiByName("PUTIH"), dateAwal.getDate());
            ...
            if (!listClosingSaldoAwalPutih.isEmpty()) {
                getReport = Main.getReportService().getKartuPembayaranWhiteReport(new Integer(txtLambung.getText()), dateAwal.getDate(), dateAkhir.getDate(), isClosedFor.CLOSING_SALDO_AWAL, new DateTime(dateAwal.getDate()).getMonthOfYear(), "NOT NULL", OsUtils.getOsName());
            } else {
                if (isFirstClosing) {
                    getReport = Main.getReportService().getKartuPembayaranWhiteReport(new Integer(txtLambung.getText()), dateAwal.getDate(), dateAkhir.getDate(), isClosedFor.CLOSING_SALDO_BULAN_LALU, new DateTime(dateAwal.getDate()).getMonthOfYear(), "NOT NULL", OsUtils.getOsName());
                } else {
                    getReport = Main.getReportService().getKartuPembayaranWhiteReport(new Integer(txtLambung.getText()), dateAwal.getDate(), dateAkhir.getDate(), isClosedFor.CLOSING_SALDO_BULAN_LALU, new DateTime(dateAwal.getDate()).minusMonths(1).getMonthOfYear(), "NULL", OsUtils.getOsName());
                }
            }
            ...
            JOptionPane.showMessageDialog(this, "Tidak Ada Data Kartu Pembayaran Untuk No.Lambung "+txtLambung.getText()+" Pada Bulan "+new DateTime(dateAwal.getDate()).monthOfYear().getAsText());
        }
